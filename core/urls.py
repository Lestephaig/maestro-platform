...
urlpatterns = [
    ...
    path('legal/acceptance-required/', views.legal_acceptance_required, name='legal_acceptance_required'),
    path('legal/accept-required/', views.accept_required_legal, name='accept_required_legal'),
    path('legal/cookie/accept/', views.accept_cookie_policy, name='accept_cookie_policy'),
